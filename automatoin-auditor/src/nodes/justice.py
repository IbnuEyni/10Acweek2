...
"""
    ...
    report += "3. **Weighted Resolution**: Tech Lead 60%, Prosecutor 25%, Defense 15% (high variance)\n"
    report += "4. **Weighted Resolution**: Tech Lead 50%, Prosecutor 30%, Defense 20% (low variance)\n\n"
